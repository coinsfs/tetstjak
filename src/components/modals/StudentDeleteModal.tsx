            ...
            <div className="flex items-start">
              ...
              <div>
                ...
                <p className="text-sm text-blue-700">
                  ...
                  Menonaktifkan akan menjaga riwayat akademik tetap utuh dan dapat diaktifkan kembali jika diperlukan.
                </p>
              </div>
            </div>
          </div>
            ...
            <div className="flex items-start">
              ...
              <div>
                ...
                <ul className="text-sm text-red-700 space-y-1">
                  <li>• Semua riwayat akademik dan nilai akan hilang</li>
                  <li>• Hasil ujian dan tugas akan terhapus</li>
                  <li>• Data kehadiran akan hilang</li>
