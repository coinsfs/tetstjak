                ...
                {student.class_details && (
                  <div className="flex items-center space-x-3">
                    ...
                    <div>
                      ...
                      <p className="font-medium text-gray-900">
                        {getGradeLabel(student.class_details.grade_level)} {student.class_details.name}
                      </p>
                    </div>
                  </div>
                )}

                {student.department_details && (
                  <div className="flex items-center space-x-3">
                    <GraduationCap className="w-4 h-4 text-gray-400" />
                    <div>
                      <p className="text-sm text-gray-500">Jurusan</p>
                      <p className="font-medium text-gray-900">
                        {student.department_details.abbreviation} - {student.department_details.name}
                      </p>
                    </div>
                  </div>
                )}
