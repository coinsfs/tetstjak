...
import { Class, CreateClassRequest, UpdateClassRequest, ExpertiseProgram, Teacher } from '../../../types/class';
...
const ClassFormModal: React.FC<ClassFormModalProps> = ({
  ...
  const availableTeachers = teachers.filter(teacher => 
    teacher.is_active && (
      ...
      (classData && teacher._id === classData.homeroom_teacher_id)
    )
  );
              ...
              >
                ...
                {availableTeachers.map((teacher) => (
                  <option key={teacher._id} value={teacher._id}>
                    {teacher.profile_details?.full_name || teacher.login_id} - {teacher.email}
                  </option>
                ))}
              </select>
