        ...
        <div className="flex-1 flex overflow-hidden">
          ...
          {profileSidebarOpen && (
            <>
              ...
              />
              <div className="fixed top-0 left-0 h-full w-80 bg-white shadow-lg z-50 transform transition-transform duration-300 ease-in-out flex flex-col border-r border-gray-200 lg:hidden">
                {/* Mobile Close Button */}
