...
const ProfileManagement: React.FC = () => {
  ...
  const handleMainMenuClick = (menu: string) => {
    // Navigate to other pages when main sidebar items are clicked
    navigate(`/${menu === 'dashboard' ? 'admin' : menu}`);
  };
  ...
  return (
    <div className="min-h-screen bg-gray-50 flex overflow-hidden">
      ...
      {/* Main Content Area */}
      <div className="flex-1 lg:ml-0 flex overflow-hidden">
        ...
        {/* Profile Sidebar */}
        <div className={`
          fixed top-0 left-0 lg:left-64 h-full w-80 bg-white shadow-lg z-50 transform transition-transform duration-300 ease-in-out flex flex-col
          ${profileSidebarOpen ? 'translate-x-0' : '-translate-x-full'}
          lg:translate-x-0 lg:static lg:z-auto
        `}>
          {/* Profile Sidebar Mobile Close Button */}
